...
public enum ResponseStatusEnum {
     ...
     * _101
     */
    _101(101, "Switching Protocols", "切换协议。服务器根据客户端的请求切换协议。只能切换到更高级的协议，例如，切换到HTTP的新版本协议"),

    /**
     * _200
     */
    _200(200, "OK", "请求成功。一般用于GET与POST请求"),
     ...
     * _417
     */
    _417(417, "Expectation Failed", "服务器无法满足Expect的请求头信息"),
    ...
    public static ResponseStatusEnum getInstance(int status) {
        return Arrays.stream(values())
                .filter(responseStatusEnum -> responseStatusEnum.status == status)
                .findFirst()
                .orElseThrow(() -> new BusinessException("HTTP Status not found: " + status));
    }
}
